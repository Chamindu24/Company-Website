            ...
            {/* THE MAP BOX */}
              ...
              <div className="absolute top-8 left-8 z-30">
                <div className="flex items-center gap-2 mb-1">
                   ...
                   <span className="text-[9px] font-mono font-bold text-emerald-900 uppercase tracking-tighter">Live Connection</span>
                </div>
                <p className="text-[10px] font-mono text-slate-400 uppercase tracking-widest">LON — CMB Axis</p>
              </div>

              {/* WORLD MAP WITH PINS */}
              <div className="relative w-full h-full flex items-center justify-center scale-150 lg:scale-[1.8]">
                
                {/* London Pin (Calculated Position) */}
                ...
                {/* Sri Lanka Pin (Calculated Position) */}
                  ...
                  dots={[
                    {
                      ...
                      end: { lat: 6.9271, lng: 79.8612 },   // Colombo
                    },
                  ]}
                />
              </div>
              ...
              <div className="absolute bottom-8 right-8 text-right opacity-30">
                  <p className="text-[8px] font-mono text-emerald-900">LAT: 51.5074 / 6.9271</p>
                  <p className="text-[8px] font-mono text-emerald-900">LNG: -0.1278 / 79.8612</p>
              </div>
