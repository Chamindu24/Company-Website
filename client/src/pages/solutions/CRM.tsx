            ...
            <div className="relative overflow-hidden rounded-4xl border border-slate-200 shadow-[0_32px_80px_rgba(0,0,0,0.10)]">
              ...
              <div className="absolute bottom-6 sm:bottom-8 left-1/2 -translate-x-1/2 w-full px-6 flex justify-center">
                <button
                  ...
                  className="group relative rounded-sm cursor-pointer inline-flex items-center gap-3 px-10 py-4 bg-white text-slate-900 font-semibold text-xs uppercase tracking-[0.18em] overflow-hidden transition-all duration-300 hover:shadow-[0_16px_48px_rgba(0,0,0,0.25)] active:scale-[0.98]"
                >
