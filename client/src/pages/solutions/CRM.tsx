        ...
        <div className="max-w-7xl pt-6 md:pt-12 mx-auto">
          ...
          <div className="relative max-w-6xl mt-12 mx-auto text-center mb-16">
            ...
            <p className="crm-fadeUp text-lg md:text-xl text-slate-500 font-light max-w-3xl mx-auto leading-relaxed">
              Customer Relationship Management (CRM) is a centralized system
              that enables businesses to manage customer data, track
              interactions, and optimize sales, marketing, and service processes
          ...
          <div className="max-w-7xl mx-auto lg:px-0">
            ...
            <div className="max-w-3xl mx-auto text-center py-16">
              ...
              <p className=" text-2xl md:text-3xl text-slate-700 font-normal  leading-snug">
                ...
                , strengthen customer relationships, and drive sustainable
                business growth.
              </p>
            </div>
          ...
          <div className="max-w-7xl mx-auto pt-8">
            <div className="text-center mb-14">
              ...
              <p className="text-lg md:text-xl text-slate-500 font-light max-w-2xl mx-auto leading-relaxed">
                Clear answers to the most common questions about CRM platforms
