            ...
            <section className=" py-24 px-6">
              <div className="max-w-7xl mx-auto">
                ...
                <div className="mb-20 text-center md:text-left">
                  <h2 className="text-emerald-700 font-black tracking-[0.4em] text-sm uppercase mb-6 flex items-center justify-center md:justify-start gap-4">
                    <span className="w-12 h-[1px] bg-emerald-200"></span>
                    Core Architecture
                  </h2>
                  <h3 className="text-5xl md:text-6xl font-extrabold text-slate-900 tracking-tight mb-8">
                    How <span className="text-emerald-600  font-normal">AI Agents</span> & Chatbots <br/> 
                    Drive Your Enterprise
                  </h3>
                  <p className="text-2xl text-slate-800 max-w-3xl  leading-relaxed">
