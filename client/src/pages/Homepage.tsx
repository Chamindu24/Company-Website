                              ...
                              {[
                                ...
                                >
                                  ...
                                  <div className="text-right">
                                    <div
                                      className={`text-[8px] px-2 py-0.5 rounded-full inline-block ${i === 0 ? "bg-emerald-100 text-emerald-700" : "bg-slate-100 text-slate-600"}`}
                                    >
                                      {lead.status}
                                    </div>
                                  </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-10 md:gap-12 items-center">
              ...
              <div className="relative group">
                ...
                <div className="relative bg-[#064e3b]/40 backdrop-blur-xl border border-emerald-200/30 p-8 md:p-10 lg:p-12 shadow-2xl">
                  <span className="hp-serif absolute -top-6 sm:-top-8 -left-2 text-7xl sm:text-9xl text-emerald-200/40 select-none italic">
                    “
                  </span>
              ...
              <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 md:gap-8">
                ...
                <div className="max-w-sm mx-auto md:mx-0">
                  <p className="text-slate-500 font-light text-base sm:text-lg leading-relaxed border-l-2 border-emerald-600 pl-5 py-2 text-center md:text-left">
                    We prioritize stability and security at every layer,
                    building software architectures that remain{" "}
