  ...
  return (
    <section className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[#030303]">
      ...
      <motion.div
        ...
        className="absolute top-32 left-24 z-10 p-6 pointer-events-none"
      >
        <motion.h1
          initial={{ letterSpacing: "1em", opacity: 0 }}
          animate={{ letterSpacing: "-0.05em", opacity: 1 }}
          transition={{ duration: 2, ease: [0.16, 1, 0.3, 1] }}
          className="text-[9vw] font-extrabold leading-none tracking-tighter text-white select-none drop-shadow-[0_10px_10px_rgba(0,0,0,0.7)]"
        >
          LUSHWARE
        </motion.h1>
      </motion.div>
      ...
      {/* UI CONTENT */}
      <div className="absolute inset-0 z-30 flex flex-col justify-end p-10 md:p-16">
        {/* BOTTOM CONTENT */}
        <div className="flex flex-col md:flex-row mb-12 items-end justify-end gap-12">
    ...
    `,
              ...
              className="text-5xl md:text-8xl tracking-tight text-white leading-[0.95]"
            >
              <motion.span
      ...
      {/* SIDE BORDERS */}
      <div className="absolute inset-0 pointer-events-none z-40 border-x border-white/5 mx-8 md:mx-16" />
    </section>
  );
}
