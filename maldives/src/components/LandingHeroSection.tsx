...
function LandingHeroSection() {
  ...
  return (
    <section className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[#030303]">
      ...
      {/* UI CONTENT */}
      <div className="absolute inset-0 z-30 flex flex-col justify-end pb-24 px-8 lg:px-2 sm:p-8 md:py-28 lg:py-16">
        {/* BOTTOM CONTENT */}
        <div className="flex flex-col md:flex-row mb-6 sm:mb-8 md:mb-12 items-end justify-end gap-6 md:gap-12">
          <div className="max-w-5xl w-full">
            <motion.h2
              ...
              className="text-[13vw] sm:text-[8vw] md:text-8xl lg:text-8xl tracking-tight text-white leading-[0.95]"
            >
              <motion.span
              ...
              <motion.span
                ...
                viewport={{ once: true }}
                transition={{ delay: 1.45, duration: 1.1, ease: [0.16, 1, 0.3, 1] }}
                style={{ display: "inline-block" }}
              >
                <span
