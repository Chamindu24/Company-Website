const featureCards = [
  {
    ...
    title: 'Maintenance',
    description: 'Smart ticketing and real-time vendor dispatch for flawless property upkeep.',
  },
  {
    icon: 'forum',
    iconColor: 'text-secondary',
    title: 'Communication',
    description: 'Unified inbox for guest requests and tenant agreements with auto-translation.',
  },
  {
    icon: 'verified_user',
    iconColor: 'text-error',
    title: 'Compliance',
    description: 'Automated local tax reporting and legal documentation for Maldivian regulations.',
  },
  {
    icon: 'support_agent',
    iconColor: 'text-primary',
    title: '24/7 Concierge',
    description: 'Dedicated account managers for white-glove platform assistance.',
  },
]
...
function RealEstateControlPage() {
  return (
        ...
        <div className="mx-auto grid max-w-7xl grid-cols-1 items-center gap-16 lg:grid-cols-2">
          <div className="z-10">
            ...
            <p className="mb-12 max-w-xl text-lg leading-relaxed text-on-surface-variant lg:text-xl">
              Experience the digital sanctuary of property management. Effortlessly oversee luxury villas and island
              retreats with Maldivian precision and global intelligence.
            </p>
              ...
              <div className="glass-panel absolute bottom-8 left-8 right-8 rounded-lg p-6 shadow-xl">
                <div className="flex items-end justify-between">
                  <div>
                    ...
                    <h3 className="font-headline text-3xl font-extrabold text-primary">94.2%</h3>
                  </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="mb-20 text-center">
            ...
            <p className="mx-auto max-w-2xl text-lg text-on-surface-variant">
              Four core pillars designed to streamline your property empire with elegance.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-3 lg:grid-cols-4">
            <div className="flex flex-col justify-between rounded-xl bg-surface-container-lowest p-8 shadow-[0_20px_40px_rgba(0,104,116,0.03)] transition-shadow hover:shadow-lg md:col-span-2 lg:col-span-2">
              <div>
                <div className="mb-6 flex h-12 w-12 items-center justify-center rounded-full bg-primary-fixed-dim/20 text-primary">
                  <span className="material-symbols-outlined">house_with_shield</span>
                </div>
                <h3 className="mb-4 font-headline text-2xl font-bold">Listings Management</h3>
                <p className="leading-relaxed text-on-surface-variant">
                  Centralize your entire portfolio. Dynamic pricing and rich media management for every unit across
                  global platforms.
                </p>
              </div>
              <div className="mt-8 flex items-center gap-4 border-t border-outline-variant/10 pt-8">
                <span className="text-sm font-bold text-primary">Explore Listings</span>
            ...
            <div className="group relative overflow-hidden rounded-xl border border-primary-container/10 bg-primary-container/5 p-8 md:col-span-1 lg:col-span-2">
              <div className="relative z-10">
                ...
                <h3 className="mb-4 font-headline text-2xl font-bold">Revenue Analytics</h3>
                <p className="leading-relaxed text-on-surface-variant">
                  Predictive insights into cash flow, yield optimization, and seasonal performance trends.
                </p>
              </div>
              <div className="absolute -bottom-10 -right-10 opacity-10 transition-transform group-hover:scale-110">
                <span className="material-symbols-outlined text-[200px]">show_chart</span>
              </div>
            </div>
            ...
            {featureCards.map((card) => (
              ...
              >
                <div>
                  <div className={`mb-6 flex h-12 w-12 items-center justify-center rounded-full ${card.iconColor === 'text-error' ? 'bg-error/10' : card.iconColor === 'text-tertiary' ? 'bg-tertiary/10' : card.iconColor === 'text-secondary' ? 'bg-secondary/10' : 'bg-primary-fixed-dim/20'} ${card.iconColor}`}>
              ...
              <div className="p-8 lg:col-span-10">
                <div className="mb-8 grid grid-cols-1 gap-6 md:grid-cols-3">
                  <div className="flex flex-col gap-2 rounded-lg bg-surface-container p-6">
                    ...
                    <span className="font-headline text-3xl font-extrabold text-on-surface">$142,500</span>
                  ...
                  <div className="flex flex-col gap-2 rounded-lg bg-surface-container p-6">
                    <span className="text-xs font-bold uppercase tracking-wider text-on-surface-variant">Active Bookings</span>
                    <span className="font-headline text-3xl font-extrabold text-on-surface">184</span>
                    <span className="text-xs font-bold text-secondary">89 Units occupied</span>
                  </div>
                  <div className="flex flex-col gap-2 rounded-lg bg-surface-container p-6">
                    <span className="text-xs font-bold uppercase tracking-wider text-on-surface-variant">Maintenance</span>
                    <span className="font-headline text-3xl font-extrabold text-on-surface">12</span>
                    <span className="text-xs font-bold text-error">3 Urgent tickets</span>
                  </div>
                </div>

                <div className="rounded-lg border border-surface-container bg-white p-6 shadow-sm">
                  <div className="mb-8 flex items-center justify-between">
                    <h4 className="font-headline text-lg font-bold">Occupancy Status</h4>
                  ...
                  <div className="flex h-64 items-end justify-between gap-4">
                    {occupancyBars.map((value, index) => (
                      <div key={occupancyDays[index]} className="group relative h-full flex-1">
                        <div
        ...
        <div className="relative mx-auto max-w-5xl overflow-hidden rounded-xl bg-gradient-to-br from-primary to-primary-container p-12 text-center lg:p-20">
          ...
          <div className="relative z-10">
            ...
            <p className="mx-auto mb-10 max-w-xl text-lg text-white/80">
              Join the leading real estate firms in the Maldives using Viduvaru to scale their excellence.
            </p>
...
export default RealEstateControlPage